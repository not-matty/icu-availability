...
document.getElementById('sendButton').addEventListener('click', async function () {
  ...
  if (userMessage.trim() !== '') {
      ...
      try {
        ...
        const llamaResponse = await getLlama2Response('Response 1: Class: CSE 310, Times: TTh 09:00-10:00, Building: GUG 220, Prerequisites: CSE 143 Class: CSE 320, Times: MWF 11:00-12:00, Building: MOR 225, Prerequisites: CSE 311 Class: CSE 420, Times: TTh 10:00-11:30, Building: SAV 168, Prerequisites: CSE 312, CSE 332 Reponse 2: Class: CSE 446, Times: MWF 10:00-11:00, Building: GUG 310, Prerequisites: CSE 332, STAT 390 Class: CSE 461, Times: TTh 11:00-12:30, Building: MGH 241, Prerequisites: CSE 451 Class: CSE 421, Times: TTh 13:00-14:30, Building: SAV 168, Prerequisites: CSE 312, CSE 332 Response 3: Class: CSE 311, Times: TTh 09:00-10:30, Building: GUG 220, Prerequisites: CSE 143 Class: CSE 321, Times: MWF 11:00-12:00, Building: MOR 225, Prerequisites: CSE 311 Class: CSE 463, Times: TTh 11:00-12:30, Building: MGH 241, Prerequisites: CSE 451 dont say anything');
